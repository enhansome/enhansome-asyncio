...
Find some of those *awesome* packages here and if you are missing one we count on you to [create an Issue or a Pull Request](https://github.com/timofurrer/awesome-asyncio/blob/master/CONTRIBUTING.md) ⭐ 5,126 | 🐛 21 | 📅 2025-12-01 with your suggestion.
...
* [FastAPI](https://github.com/tiangolo/fastapi) ⭐ 102,231 | 🐛 81 | 🌐 Python | 📅 2026-09-01 - A very high performance Python 3.6+ API framework based on type hints. Powered by Starlette and Pydantic.
* [sanic](https://github.com/channelcat/sanic) ⭐ 18,639 | 🐛 148 | 🌐 Python | 📅 2026-07-29 - Python 3.5+ web server that's written to go fast.
* [aiohttp](https://github.com/KeepSafe/aiohttp) ⭐ 16,547 | 🐛 215 | 🌐 Python | 📅 2026-09-10 - Http client/server for asyncio (PEP-3156).
* [Starlette](https://github.com/encode/starlette) ⭐ 12,612 | 🐛 45 | 🌐 Python | 📅 2026-09-07 - A lightweight ASGI framework/toolkit for building high performance services.
* [uvicorn](https://github.com/encode/uvicorn) ⭐ 10,954 | 🐛 91 | 🌐 Python | 📅 2026-09-09 - The lightning-fast ASGI server.
* [websockets](https://github.com/aaugustin/websockets/) ⭐ 5,716 | 🐛 2 | 🌐 Python | 📅 2026-08-29 - A library for building WebSocket servers and clients in Python with a focus on correctness and simplicity.
* [Quart](https://github.com/pallets/quart) ⭐ 3,669 | 🐛 26 | 🌐 Python | 📅 2026-08-29 - An asyncio web microframework with the same API as Flask.
* [autobahn](https://github.com/crossbario/autobahn-python) ⭐ 2,542 | 🐛 187 | 🌐 Python | 📅 2026-07-15 - WebSocket and WAMP supporting asyncio and Twisted, for clients and servers.
...
* [pyzmq](https://github.com/zeromq/pyzmq) ⭐ 4,172 | 🐛 60 | 🌐 Python | 📅 2026-09-07 - Python bindings for ZeroMQ.
* [crossbar](https://github.com/crossbario/crossbar) ⭐ 2,063 | 🐛 305 | 🌐 Python | 📅 2026-09-07 - Crossbar.io is a networking platform for distributed and microservice applications.
* [aiokafka](https://github.com/aio-libs/aiokafka) ⭐ 1,401 | 🐛 192 | 🌐 Python | 📅 2026-09-10 - Client for Apache Kafka.
* [asyncio-nats](https://github.com/nats-io/asyncio-nats) ⭐ 1,247 | 🐛 110 | 🌐 Python | 📅 2026-09-07 - Client for the NATS messaging system.
...
* [redis-py](https://github.com/redis/redis-py) ⭐ 13,632 | 🐛 80 | 🌐 Python | 📅 2026-09-10 - Redis Python Client (which includes [aioreadis](https://github.com/aio-libs/aioredis) ⚠️ Archived now).
* [asyncpg](https://github.com/MagicStack/asyncpg) ⭐ 8,087 | 🐛 305 | 🌐 Python | 📅 2026-02-27 - Fast PostgreSQL Database Client Library for Python/asyncio.
* [Tortoise ORM](https://github.com/tortoise/tortoise-orm) ⭐ 5,625 | 🐛 546 | 🌐 Python | 📅 2026-09-10 - native multi-backend ORM with Django-like API and easy relations management.
* [pymongo](https://github.com/mongodb/mongo-python-driver) ⭐ 4,357 | 🐛 15 | 🌐 Python | 📅 2026-09-10 - The Official MongoDB Python driver, offering both synchronous and asynchronous APIs.
* [Beanie](https://beanie-odm.dev) - An async MongoDB ODM built on [pymongo](https://github.com/mongodb/mongo-python-driver) ⭐ 4,357 | 🐛 15 | 🌐 Python | 📅 2026-09-10 and [Pydantic](https://pydantic-docs.helpmanual.io).
...
* [GINO](https://github.com/fantix/gino) ⭐ 2,790 | 🐛 54 | 🌐 Python | 📅 2022-02-12 - is a lightweight asynchronous Python ORM based on [SQLAlchemy](https://www.sqlalchemy.org/) core, with [asyncpg](https://github.com/MagicStack/asyncpg) ⭐ 8,087 | 🐛 305 | 🌐 Python | 📅 2026-02-27 dialect.
...
* [Piccolo](https://github.com/piccolo-orm/piccolo) ⭐ 1,941 | 🐛 45 | 🌐 Python | 📅 2026-09-07 - An ORM / query builder which can work in async and sync modes, with a nice admin GUI, and ASGI middleware.
* [aiomysql](https://github.com/aio-libs/aiomysql) ⭐ 1,895 | 🐛 117 | 🌐 Python | 📅 2026-03-27 - Library for accessing a MySQL database
* [aiopg](https://github.com/aio-libs/aiopg/) ⭐ 1,431 | 🐛 89 | 🌐 Python | 📅 2025-12-03 - Library for accessing a PostgreSQL database.
* [peewee-async](https://github.com/05bit/peewee-async) ⭐ 763 | 🐛 4 | 🌐 Python | 📅 2026-09-09 - ORM implementation based on [peewee](https://github.com/coleifer/peewee) ⭐ 11,987 | 🐛 0 | 🌐 Python | 📅 2026-09-08 and aiopg.
* [asyncpgsa](https://github.com/CanopyTax/asyncpgsa) ⭐ 506 | 🐛 15 | 🌐 Python | 📅 2024-02-17 - Asyncpg with sqlalchemy core support.
...
* [httpx](https://github.com/encode/httpx) ⭐ 15,472 | 🐛 142 | 🌐 Python | 📅 2026-03-29 - asynchronous HTTP client for Python 3 with [requests](https://github.com/psf/requests) ⭐ 54,293 | 🐛 237 | 🌐 Python | 📅 2026-09-07 compatible API.
* [AsyncSSH](https://github.com/ronf/asyncssh) ⭐ 1,757 | 🐛 15 | 🌐 Python | 📅 2026-09-05 - Provides an asynchronous client and server implementation of the SSHv2 protocol.
...
* [pytest-asyncio](https://github.com/pytest-dev/pytest-asyncio) ⭐ 1,662 | 🐛 51 | 🌐 Python | 📅 2026-09-09 - Pytest support for asyncio.
...
* [aresponses](https://github.com/CircleUp/aresponses) ⭐ 106 | 🐛 5 | 🌐 Python | 📅 2024-07-11 - Asyncio http mocking. Similar to the [responses](https://github.com/getsentry/responses) ⭐ 4,344 | 🐛 42 | 🌐 Python | 📅 2026-08-26 library used for [requests](https://github.com/requests/requests) ⭐ 54,293 | 🐛 237 | 🌐 Python | 📅 2026-09-07.
...
* [uvloop](https://github.com/MagicStack/uvloop) ⭐ 11,898 | 🐛 159 | 🌐 Cython | 📅 2026-07-14 - Ultra fast implementation of asyncio event loop on top of libuv.

## Misc

*Other awesome asyncio libraries.*

* [aiofiles](https://github.com/Tinche/aiofiles/) ⭐ 3,259 | 🐛 58 | 🌐 Python | 📅 2026-08-29 - File support for asyncio.
* [ruia](https://github.com/howie6879/ruia) ⭐ 1,737 | 🐛 9 | 🌐 Python | 📅 2023-07-01 - An async web scraping micro-framework based on asyncio.
* [asgiref](https://github.com/django/asgiref) ⭐ 1,632 | 🐛 66 | 🌐 Python | 📅 2026-09-04 - Backend utils for ASGI to WSGI integration, includes sync\_to\_async and async\_to\_sync function wrappers.
* [aiocache](https://github.com/argaen/aiocache) ⭐ 1,437 | 🐛 67 | 🌐 Python | 📅 2026-06-28 - Cache manager for different backends.
* [aiorun](https://github.com/cjrh/aiorun) ⭐ 469 | 🐛 2 | 🌐 Python | 📅 2026-08-20 - A `run()` function that handles all the usual boilerplate for startup and graceful shutdown.
* [kubernetes\_asyncio](https://github.com/tomplus/kubernetes_asyncio) ⭐ 436 | 🐛 32 | 🌐 Python | 📅 2026-08-12 - Asynchronous client library for Kubernetes.
* [aiomisc](https://github.com/aiokitchen/aiomisc) ⭐ 425 | 🐛 10 | 🌐 Python | 📅 2026-09-10 - Miscellaneous utils for `asyncio`.
* [aiopath](https://github.com/alexdelorenzo/aiopath) ⭐ 197 | 🐛 26 | 🌐 Python | 📅 2026-02-05 - Asynchronous `pathlib` for asyncio.
* [aiozipkin](https://github.com/aio-libs/aiozipkin) ⭐ 193 | 🐛 23 | 🌐 Python | 📅 2026-08-31 - Distributed tracing instrumentation for asyncio with zipkin
...
* [aioserial](https://github.com/changyuheng/aioserial) ⭐ 145 | 🐛 15 | 🌐 Python | 📅 2022-07-25 - A drop-in replacement of [pySerial](https://github.com/pyserial/pyserial) ⭐ 3,571 | 🐛 341 | 🌐 Python | 📅 2026-05-19.
...
* [trio](https://github.com/python-trio/trio) ⭐ 7,317 | 🐛 326 | 🌐 Python | 📅 2026-09-07 - Pythonic async I/O for humans and snake people.
...
* [AnyIO](https://github.com/agronholm/anyio) ⭐ 2,538 | 🐛 110 | 🌐 Python | 📅 2026-09-07 - High level asynchronous concurrency and networking framework that works on top of either trio or asyncio.
