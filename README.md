...
* [FastAPI](https://github.com/tiangolo/fastapi) ⭐ 102,282 | 🐛 82 | 🌐 Python | 📅 2026-09-01 - A very high performance Python 3.6+ API framework based on type hints. Powered by Starlette and Pydantic.
* [sanic](https://github.com/channelcat/sanic) ⭐ 18,638 | 🐛 148 | 🌐 Python | 📅 2026-07-29 - Python 3.5+ web server that's written to go fast.
* [aiohttp](https://github.com/KeepSafe/aiohttp) ⭐ 16,548 | 🐛 219 | 🌐 Python | 📅 2026-09-11 - Http client/server for asyncio (PEP-3156).
* [Starlette](https://github.com/encode/starlette) ⭐ 12,615 | 🐛 44 | 🌐 Python | 📅 2026-09-12 - A lightweight ASGI framework/toolkit for building high performance services.
* [uvicorn](https://github.com/encode/uvicorn) ⭐ 10,958 | 🐛 89 | 🌐 Python | 📅 2026-09-12 - The lightning-fast ASGI server.
* [websockets](https://github.com/aaugustin/websockets/) ⭐ 5,716 | 🐛 5 | 🌐 Python | 📅 2026-09-12 - A library for building WebSocket servers and clients in Python with a focus on correctness and simplicity.
* [Quart](https://github.com/pallets/quart) ⭐ 3,670 | 🐛 25 | 🌐 Python | 📅 2026-09-12 - An asyncio web microframework with the same API as Flask.
...
* [crossbar](https://github.com/crossbario/crossbar) ⭐ 2,064 | 🐛 305 | 🌐 Python | 📅 2026-09-07 - Crossbar.io is a networking platform for distributed and microservice applications.
...
* [redis-py](https://github.com/redis/redis-py) ⭐ 13,636 | 🐛 81 | 🌐 Python | 📅 2026-09-10 - Redis Python Client (which includes [aioreadis](https://github.com/aio-libs/aioredis) ⚠️ Archived now).
* [asyncpg](https://github.com/MagicStack/asyncpg) ⭐ 8,087 | 🐛 306 | 🌐 Python | 📅 2026-02-27 - Fast PostgreSQL Database Client Library for Python/asyncio.
* [Tortoise ORM](https://github.com/tortoise/tortoise-orm) ⭐ 5,626 | 🐛 534 | 🌐 Python | 📅 2026-09-12 - native multi-backend ORM with Django-like API and easy relations management.
...
* [GINO](https://github.com/fantix/gino) ⭐ 2,790 | 🐛 54 | 🌐 Python | 📅 2022-02-12 - is a lightweight asynchronous Python ORM based on [SQLAlchemy](https://www.sqlalchemy.org/) core, with [asyncpg](https://github.com/MagicStack/asyncpg) ⭐ 8,087 | 🐛 306 | 🌐 Python | 📅 2026-02-27 dialect.
...
* [peewee-async](https://github.com/05bit/peewee-async) ⭐ 763 | 🐛 4 | 🌐 Python | 📅 2026-09-09 - ORM implementation based on [peewee](https://github.com/coleifer/peewee) ⭐ 11,985 | 🐛 0 | 🌐 Python | 📅 2026-09-08 and aiopg.
...
* [httpx](https://github.com/encode/httpx) ⭐ 15,474 | 🐛 142 | 🌐 Python | 📅 2026-03-29 - asynchronous HTTP client for Python 3 with [requests](https://github.com/psf/requests) ⭐ 54,302 | 🐛 237 | 🌐 Python | 📅 2026-09-07 compatible API.
* [AsyncSSH](https://github.com/ronf/asyncssh) ⭐ 1,757 | 🐛 15 | 🌐 Python | 📅 2026-09-12 - Provides an asynchronous client and server implementation of the SSHv2 protocol.
...
* [aresponses](https://github.com/CircleUp/aresponses) ⭐ 106 | 🐛 5 | 🌐 Python | 📅 2024-07-11 - Asyncio http mocking. Similar to the [responses](https://github.com/getsentry/responses) ⭐ 4,344 | 🐛 45 | 🌐 Python | 📅 2026-08-26 library used for [requests](https://github.com/requests/requests) ⭐ 54,302 | 🐛 237 | 🌐 Python | 📅 2026-09-07.
...
* [uvloop](https://github.com/MagicStack/uvloop) ⭐ 11,899 | 🐛 160 | 🌐 Cython | 📅 2026-07-14 - Ultra fast implementation of asyncio event loop on top of libuv.
...
* [kubernetes\_asyncio](https://github.com/tomplus/kubernetes_asyncio) ⭐ 436 | 🐛 31 | 🌐 Python | 📅 2026-09-11 - Asynchronous client library for Kubernetes.
...
* [aioserial](https://github.com/changyuheng/aioserial) ⭐ 145 | 🐛 15 | 🌐 Python | 📅 2022-07-25 - A drop-in replacement of [pySerial](https://github.com/pyserial/pyserial) ⭐ 3,570 | 🐛 341 | 🌐 Python | 📅 2026-05-19.
...
* [trio](https://github.com/python-trio/trio) ⭐ 7,322 | 🐛 326 | 🌐 Python | 📅 2026-09-07 - Pythonic async I/O for humans and snake people.
...
* [AnyIO](https://github.com/agronholm/anyio) ⭐ 2,540 | 🐛 109 | 🌐 Python | 📅 2026-09-12 - High level asynchronous concurrency and networking framework that works on top of either trio or asyncio.
